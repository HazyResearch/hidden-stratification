                        ...
                        nn.Sequential(
                            OrderedDict(
                                [
                                    (
                                        'unit01',
                                        PreActBottleneck(cin=64 * wf, cout=256 * wf, cmid=64 * wf),
                                    )
                                ]
                                + [
                                    (
                            ...
                            OrderedDict(
                                [
                                    (
                                        'unit01',
                                        PreActBottleneck(
                                            cin=256 * wf, cout=512 * wf, cmid=128 * wf, stride=2
                                        ),
                                    )
                                ]
                                + [
                            ...
                            OrderedDict(
                                [
                                    (
                                        'unit01',
                                        PreActBottleneck(
                                            cin=512 * wf, cout=1024 * wf, cmid=256 * wf, stride=2
                                        ),
                                    )
                                ]
                                + [
                            ...
                            OrderedDict(
                                [
                                    (
                                        'unit01',
                                        PreActBottleneck(
                                            cin=1024 * wf, cout=2048 * wf, cmid=512 * wf, stride=2
                                        ),
                                    )
                                ]
                                + [
...
def BiTResNet(pretrained=True, **kwargs):
    ...
    if not os.path.isfile(model_path):
        download_url(
            'https://storage.googleapis.com/bit_models/BiT-M-R50x1.npz', os.path.dirname(model_path)
        )
